...
if(QHULL_USE_STATIC)
  ...
  if(${HAVE_QHULL_REENTRANT_HEADERS} MATCHES ON)
      set(QHULL_REENTRANT_RELEASE_NAME qhullstatic_r)
      set(QHULL_REENTRANT_DEBUG_NAME qhullstatic_rd)
  endif(${HAVE_QHULL_REENTRANT_HEADERS} MATCHES ON)
  ...
  set(QHULLCPP_RELEASE_NAME qhullcpp${QHULL_MAJOR_VERSION})
  ...
  set(QHULLCPP_DEBUG_NAME qhullcpp${QHULL_MAJOR_VERSION}_d)
...
find_library(QHULL_LIBRARY
             ...
             HINTS "${QHULL_ROOT}/lib" "$ENV{QHULL_ROOT}/lib"
             PATHS "$ENV{PROGRAMFILES}/QHull" "$ENV{PROGRAMW6432}/QHull"
             PATH_SUFFIXES project build bin lib)

find_library(QHULL_REENTRANT_LIBRARY
             NAMES ${QHULL_REENTRANT_RELEASE_NAME}
             HINTS "${QHULL_ROOT}/lib" "$ENV{QHULL_ROOT}/lib"
             PATHS "$ENV{PROGRAMFILES}/QHull" "$ENV{PROGRAMW6432}/QHull"
             PATH_SUFFIXES project build bin lib)
...
find_library(QHULL_REENTRANT_LIBRARY_DEBUG
             NAMES ${QHULL_DEBUG_NAME}
             HINTS "${QHULL_ROOT}/lib" "$ENV{QHULL_ROOT}/lib"
             PATHS "$ENV{PROGRAMFILES}/QHull" "$ENV{PROGRAMW6432}/QHull"
             PATH_SUFFIXES project build bin lib)
...
find_library(QHULLCPP_LIBRARY_DEBUG
             NAMES ${QHULLCPP_DEBUG_NAME}
             HINTS "${QHULL_ROOT}/lib" "$ENV{QHULL_ROOT}/lib"
             PATHS "$ENV{PROGRAMFILES}/QHull" "$ENV{PROGRAMW6432}/QHull"
             PATH_SUFFIXES project build bin lib)

if(QHULL_REENTRANT_LIBRARY)
    get_filename_component(qhull_library ${QHULL_REENTRANT_LIBRARY} NAME_WE)
...
endif(QHULL_REENTRANT_LIBRARY)

set(QHULL_INCLUDE_DIRS ${QHULL_INCLUDE_DIR})
if(${CMAKE_BUILD_TYPE} MATCHES "Release")
    set(QHULL_LIBRARIES ${QHULL_LIBRARY})
    if(${HAVE_QHULL_REENTRANT_LIB} MATCHES ON)
        set(QHULL_REENTRANT_LIBRARIES ${QHULLCPP_LIBRARY} ${QHULL_REENTRANT_LIBRARY})
    endif(${HAVE_QHULL_REENTRANT_LIB} MATCHES ON)
elseif(${CMAKE_BUILD_TYPE} MATCHES "Debug")
    set(QHULL_LIBRARIES ${QHULL_LIBRARY_DEBUG})
    if(${HAVE_QHULL_REENTRANT_LIB} MATCHES ON)
        set(QHULL_REENTRANT_LIBRARIES ${QHULLCPP_LIBRARY_DEBUG} ${QHULL_REENTRANT_LIBRARY_DEBUG})
    endif(${HAVE_QHULL_REENTRANT_LIB} MATCHES ON)
...
if(QHULL_FOUND)
  ...
  if(HAVE_QHULL_REENTRANT)
      message(STATUS "QHULL reentrant found (include: ${QHULL_INCLUDE_DIRS}, lib: ${QHULL_REENTRANT_LIBRARIES})")
  endif(HAVE_QHULL_REENTRANT)
endif(QHULL_FOUND)
